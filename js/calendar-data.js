...
// NOTE: routine events and dated lab events moved to data/calendar.json —
// edit them through the admin panel (Pages CMS). This file keeps only the
// holiday reference data below.
...
const fixedHolidays = {
    ...
    "12-31": { title: "跨年夜!!! Happy New Year!!", description: "New Year's Eve Party", type: "holiday" },
};
